# Print Asset Work Order — geography-03

**Lesson:** Regions & Communities
...
|---|---|---|---|---|
| hero | Regions & Communities hero | `assets/source-images/geography-03/hero.jpg` | `assets/images/geography-03-hero.png` | ready for imagegen conversion |
| s1 | What Is a Region? | `assets/source-images/geography-03/s1.jpg` | `assets/images/geography-03-s1.png` | ready for imagegen conversion |
| s2 | Weather and Climate | `assets/source-images/geography-03/s2.jpg` | `assets/images/geography-03-s2.png` | ready for imagegen conversion |
| s3 | Natural Resources | `assets/source-images/geography-03/s3.jpg` | `assets/images/geography-03-s3.png` | ready for imagegen conversion |
| s4 | Transportation and Routes | `assets/source-images/geography-03/s4.jpg` | `assets/images/geography-03-s4.png` | ready for imagegen conversion |
| s5 | Quick Check + Community Plan | `assets/source-images/geography-03/s5.jpg` | `assets/images/geography-03-s5.png` | ready for imagegen conversion |

# Print Asset Work Order — history-03

**Lesson:** American Independence & World Ideas
...
|---|---|---|---|---|
| hero | American Independence & World Ideas hero | `assets/source-images/history-03/hero.jpg` | `assets/images/history-03-hero.png` | ready for imagegen conversion |
| s1 | Colonies in North America | `assets/source-images/history-03/s1.jpg` | `assets/images/history-03-s1.png` | ready for imagegen conversion |
| s2 | The American Revolution | `assets/source-images/history-03/s2.jpg` | `assets/images/history-03-s2.png` | ready for imagegen conversion |
| s3 | Symbols Tell Stories | `assets/source-images/history-03/s3.jpg` | `assets/images/history-03-s3.png` | ready for imagegen conversion |
| s4 | Ideas Travel Around the World | `assets/source-images/history-03/s4.jpg` | `assets/images/history-03-s4.png` | ready for imagegen conversion |
| s5 | Quick Check + Civic Poster | `assets/source-images/history-03/s5.jpg` | `assets/images/history-03-s5.png` | ready for imagegen conversion |

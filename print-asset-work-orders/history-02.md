# Print Asset Work Order — history-02

**Lesson:** Rivers, Cities & Early America
...
|---|---|---|---|---|
| hero | Rivers, Cities & Early America hero | `assets/source-images/history-02/hero.jpg` | `assets/images/history-02-hero.png` | ready for imagegen conversion |
| s1 | Rivers Help Communities Grow | `assets/source-images/history-02/s1.jpg` | `assets/images/history-02-s1.png` | ready for imagegen conversion |
| s2 | Ancient Egypt and the Nile | `assets/source-images/history-02/s2.jpg` | `assets/images/history-02-s2.png` | ready for imagegen conversion |
| s3 | Ancient Cities and Writing | `assets/source-images/history-02/s3.jpg` | `assets/images/history-02-s3.png` | ready for imagegen conversion |
| s4 | Indigenous Communities in North America | `assets/source-images/history-02/s4.jpg` | `assets/images/history-02-s4.png` | ready for imagegen conversion |
| s5 | Quick Check + Compare Communities | `assets/source-images/history-02/s5.jpg` | `assets/images/history-02-s5.png` | ready for imagegen conversion |
